...
# Set False Path
#**************************************************************
set_false_path -from DRAM_DQ*  -to *
...
set_false_path -from *  -to DRAM_ADDR*
set_false_path -from *  -to DRAM_DQ*
set_false_path -from *  -to LEDR*
set_false_path -from *  -to DRAM_BA*


set_false_path -from *  -to DRAM_CAS_N
set_false_path -from *  -to DRAM_RAS_N
set_false_path -from *  -to DRAM_CLK
set_false_path -from *  -to DRAM_CS_N
set_false_path -from *  -to DRAM_LDQM
set_false_path -from *  -to DRAM_UDQM
set_false_path -from *  -to DRAM_WE_N
