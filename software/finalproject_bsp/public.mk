...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../finalproject.sopcinfo
...
# Design Name 
# setting SOPC_NAME is finalproject
SOPC_NAME := finalproject
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x31d0
SOPC_SYSID_FLAG += --sidp=0x31d0
ELF_PATCH_FLAG  += --sidp 0x31d0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1681343174
SOPC_SYSID_FLAG += --timestamp=1681343174
ELF_PATCH_FLAG  += --timestamp 1681343174
