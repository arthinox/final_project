	lab62_soc u0 (
		.accu_button_export             (<connected-to-accu_button_export>),             //             accu_button.export
		...
		.i2c_wire_sda_in                (<connected-to-i2c_wire_sda_in>),                //                i2c_wire.sda_in
		.i2c_wire_scl_in                (<connected-to-i2c_wire_scl_in>),                //                        .scl_in
		.i2c_wire_sda_oe                (<connected-to-i2c_wire_sda_oe>),                //                        .sda_oe
		.i2c_wire_scl_oe                (<connected-to-i2c_wire_scl_oe>)                 //                        .scl_oe
	);
