...
module lab62_soc_mm_interconnect_0 (
	...
	wire   [16:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> i2c_0_csr_agent:cp_channel
	...
	wire  [108:0] accumulator_s1_agent_rf_source_data;                                                // accumulator_s1_agent:rf_source_data -> accumulator_s1_agent_rsp_fifo:in_data
	...
	wire  [108:0] accumulator_s1_agent_rsp_fifo_out_data;                                             // accumulator_s1_agent_rsp_fifo:out_data -> accumulator_s1_agent:rf_sink_data
	...
	wire  [107:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> accumulator_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // accumulator_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [16:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> accumulator_s1_agent:cp_channel
	...
	wire  [107:0] accumulator_s1_agent_rp_data;                                                       // accumulator_s1_agent:rp_data -> router_009:sink_data
	...
	wire          i2c_0_csr_agent_rdata_fifo_src_valid;                                               // i2c_0_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] i2c_0_csr_agent_rdata_fifo_src_data;                                                // i2c_0_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          i2c_0_csr_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_002:in_0_ready -> i2c_0_csr_agent:rdata_fifo_src_ready
	...
	lab62_soc_mm_interconnect_0_router_002 router_018 (
	...
	lab62_soc_mm_interconnect_0_cmd_mux cmd_mux_016 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab62_soc_mm_interconnect_0_rsp_demux rsp_demux_016 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
